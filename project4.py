"""
script: project4.py
action: College Data System with Employees and Students
        a. Load data from text files
        b. Display various reports via a menu
        c. Allow user to search for specific students or employees
